...
async function createTowerEvent() {
  try {
    ...
    await towerEventsService.createTowerEvent(eventData)
      ...
      <div class="row justify-content-center">
        ...
        <div class="col-lg-4">
          <div class="form-floating my-3">
            <input v-model="editableEventData.name" type="text" class="form-control" id="towerEventName" placeholder="Name..." minlength="3"
                   maxlength="50" required>
            <label for="towerEventName">Event Name</label>
          </div>
          <div class="form-floating mb-3">
            <input v-model="editableEventData.location" type="text" class="form-control" id="towerEventLocation" placeholder="Address or Meet-Up Spot..."
                   maxlength="500" required>
            <label for="towerEventLocation">Event Location</label>
          </div>
          <div class="form-floating mb-3">
            <select v-model="editableEventData.type" class="form-select" aria-label="Event Type" id="eventType" required>
          ...
          <div class="form-floating mb-3">
            <input v-model="editableEventData.capacity" type="number" class="form-control" id="towerEventCapacity" placeholder="Address or Meet-Up Spot..."
                   min="1" max="5000" required>
            <label for="towerEventCapacity">Capacity</label>
          </div>
          <div class="form-floating mb-3">
            <input v-model="editableEventData.startDate" type="date" class="form-control" id="towerEventDate" placeholder="Address or Meet-Up Spot..."
                   min="1" max="5000" required>
            <label for="towerEventDate">Date</label>
          </div>
          <div class="form-floating mb-3">
            <input v-model="editableEventData.coverImg" type="url" class="form-control" id="eventCoverImg" placeholder="Image URL..."
                   maxlength="500" required>
        ...
        <div class="col-lg-10">
          <div class="form-floating my-3">
            <textarea v-model="editableEventData.description" type="text" class="form-control" id="towerEventDescription" placeholder="Event Details..."
